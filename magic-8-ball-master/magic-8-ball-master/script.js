...
let ballon= 'maybe'
let ball= 'never'
let higgins= 'whatever'  

  magic8Ball.listOfAnswers = [magic,ballon,ball,higgins]
  $("#answer").hide();
  ...
  /* 
    ...
    2c. Whoaaaa... why did that happen?
        Answer: It's a prebuilt function and each time I decreased the number the time it took for me to recieve an answer was shorter.
  ...
  */
    ...
    /*
      ...
      3b. What happened?
          Answer: I received the same answer every time I asked a question.



      3c. Try putting 1. What happened then?
          Answer: Each number I put it in it gave me that exact string/variable that was put into my array of whichever number I chose. I recieve that same answer every time until i put back in randomIndex and it randomized the answers I will recieve by picking through all the numbers(answers) and not just one.
      ...
      3d. If you hadn't already explained above, why did the things that happened for 3b and 3c happen? If you already
          ...
          Answer: knock knock... whose there? Hello... Hello who? Hello its nice to meet ya!!
    ...
    */
    ...
    /*
      ...
      4a. Where the heck are we going to see the question and answer printed from the two
          console.log() below??
          Answer: First you right click and then hit inspect.You will then find your question and answer in the console below the other setting, styles.
  ...
  magic8Ball.askQuestion = function(question) {
      ...
      magic8Ball = {
        listOfAnswers: [magic,ballon,ball,higgins],
        otherKey: 24,
  ...
  */
  ...
  var onClick = function() {
    ...
    */
    $("#8ball").attr("src", 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F30469734968699058%2F&psig=AOvVaw1Egn70qxmwhcHQVQEX8Ttn&ust=1701456643306000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCOCGkquy7IIDFQAAAAAdAAAAABAQhttps://s3.amazonaws.com/media.skillcrush.com/skillcrush/wp-content/uploads/2016/09/magic8ballQuestion.png');
